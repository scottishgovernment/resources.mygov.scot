...
\*------------------------------------*/
/*
 * Grid system setup. MyGov Assets currently uses CSSWizardry Grids but that
 * grid framework is not mandatory.
 */
/*------------------------------------*\
    $MYGOV ASSETS GRID
\*------------------------------------*/
...
/*
 * The core mygov styles. These core styles are required for correct display of
 * all of the MyGov Assets components.
 */
/*------------------------------------*\
    $MYGOV ASSETS CORE
\*------------------------------------*/
 ...
 * Use with .grid__item or whichever containing element you wish to enlarge.
 */
...
article a[href^="https://"]:not(.button) {
  background-image: url("../images/icons/arrows/ext_arrow_text_15px.png");
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  ...
  article a[href^="http://"]:not(.button),
  article a[href^="https://"]:not(.button) {
    background-image: url("../images/icons/arrows/ext_arrow_text_15px_@2x.png");
...
article a[href^="https://"]:not(.button):active {
  background-image: url("../images/icons/arrows/ext_arrow_text_15px_hover.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  article a[href^="//"]:not(.button):hover, article a[href^="//"]:not(.button):active,
  article a[href^="http://"]:not(.button):hover,
  ...
  article a[href^="https://"]:not(.button):hover,
  article a[href^="https://"]:not(.button):active {
    background-image: url("../images/icons/arrows/ext_arrow_text_15px_hover_@2x.png");
    background-size: 15px 15px;
  }
}
...
article h3 a[href^="https://"]:not(.button) {
  background-image: url("../images/icons/arrows/ext_arrow_text_17px.png");
  background-position: center right;
  background-repeat: no-repeat;
  padding-right: 22px;
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  ...
  article h3 a[href^="http://"]:not(.button),
  article h3 a[href^="https://"]:not(.button) {
    background-image: url("../images/icons/arrows/ext_arrow_text_17px_@2x.png");
...
article h3 a[href^="https://"]:not(.button):active {
  background-image: url("../images/icons/arrows/ext_arrow_text_17px_hover.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  article h2 a[href^="//"]:not(.button):hover, article h2 a[href^="//"]:not(.button):active,
  article h2 a[href^="http://"]:not(.button):hover,
  ...
  article h3 a[href^="https://"]:not(.button):hover,
  article h3 a[href^="https://"]:not(.button):active {
    background-image: url("../images/icons/arrows/ext_arrow_text_17px_hover_@2x.png");
    background-size: 17px 17px;
  }
}
...
@media (min-width: 768px) {
  ...
  article .small a[href^="//"]:not(.button), article label.minor a[href^="//"]:not(.button),
  article .small a[href^="http://"]:not(.button),
  article label.minor a[href^="http://"]:not(.button),
  article .small a[href^="https://"]:not(.button),
  article label.minor a[href^="https://"]:not(.button) {
    background-image: url("../images/icons/arrows/ext_arrow_text_15px.png");
    background-position: center right;
    background-repeat: no-repeat;
    padding-right: 20px;
...
@media (min-width: 768px) {
  article .small a[href^="//"]:not(.button):hover, article label.minor a[href^="//"]:not(.button):hover, article .small a[href^="//"]:not(.button):active, article label.minor a[href^="//"]:not(.button):active,
  article .small a[href^="http://"]:not(.button):hover,
  article label.minor a[href^="http://"]:not(.button):hover,
  article .small a[href^="http://"]:not(.button):active,
  article label.minor a[href^="http://"]:not(.button):active,
  article .small a[href^="https://"]:not(.button):hover,
  article label.minor a[href^="https://"]:not(.button):hover,
  article .small a[href^="https://"]:not(.button):active,
  article label.minor a[href^="https://"]:not(.button):active {
    background-image: url("../images/icons/arrows/ext_arrow_text_15px_hover.png");
  }
}
@media only screen and (min-width: 768px) and (min--moz-device-pixel-ratio: 1.3), only screen and (min-width: 768px) and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (min-width: 768px) and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-width: 768px) and (min-device-pixel-ratio: 1.3), only screen and (min-width: 768px) and (min-resolution: 1.3dppx) {
...
@media (min-width: 768px) {
  ...
  article h3 a[href^="http://"]:not(.button),
  article h3 a[href^="https://"]:not(.button) {
    background-image: url("../images/icons/arrows/ext_arrow_text_21px.png");
    background-position: center right;
    background-repeat: no-repeat;
    padding-right: 26px;
  }
...
@media only screen and (min-width: 768px) and (min--moz-device-pixel-ratio: 1.3), only screen and (min-width: 768px) and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (min-width: 768px) and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-width: 768px) and (min-device-pixel-ratio: 1.3), only screen and (min-width: 768px) and (min-resolution: 1.3dppx) {
  ...
  article h3 a[href^="http://"]:not(.button),
  article h3 a[href^="https://"]:not(.button) {
    background-image: url("../images/icons/arrows/ext_arrow_text_21px_@2x.png");
...
@media (min-width: 768px) {
  ...
  article h3 a[href^="https://"]:not(.button):hover,
  article h3 a[href^="https://"]:not(.button):active {
    background-image: url("../images/icons/arrows/ext_arrow_text_21px_hover.png");
  }
}
@media only screen and (min-width: 768px) and (min--moz-device-pixel-ratio: 1.3), only screen and (min-width: 768px) and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (min-width: 768px) and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-width: 768px) and (min-device-pixel-ratio: 1.3), only screen and (min-width: 768px) and (min-resolution: 1.3dppx) {
  article h2 a[href^="//"]:not(.button):hover, article h2 a[href^="//"]:not(.button):active,
  ...
  article h3 a[href^="https://"]:not(.button):hover,
  article h3 a[href^="https://"]:not(.button):active {
    background-image: url("../images/icons/arrows/ext_arrow_text_21px_hover_@2x.png");
    background-size: 21px 21px;
  }
}
...
@media (min-width: 768px) {
  ...
  .small a.external, label.minor a.external {
    background-image: url("../images/icons/arrows/ext_arrow_text_15px.png");
    background-position: center right;
    background-repeat: no-repeat;
    padding-right: 20px;
...
@media (min-width: 768px) {
  .small a.external:hover, label.minor a.external:hover, .small a.external:active, label.minor a.external:active {
    background-image: url("../images/icons/arrows/ext_arrow_text_15px_hover.png");
  }
}
@media only screen and (min-width: 768px) and (min--moz-device-pixel-ratio: 1.3), only screen and (min-width: 768px) and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (min-width: 768px) and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-width: 768px) and (min-device-pixel-ratio: 1.3), only screen and (min-width: 768px) and (min-resolution: 1.3dppx) {
...
label.disabled, legend.disabled {
  color: #b3b3b3;
}
label span.disabled, legend span.disabled {
  color: #b3b3b3;
}
...
.server-side-errors.server-side-neutral {
  color: #727272;
}
...
/* Input field errors */
.input-error {
  border: 2px solid #d32205 !important;
}
...
fieldset .input-wrapper.input-error {
  ...
  border: 1px dashed #d32205 !important;
  border-radius: 6px;
  padding: 0 15px 14px;
}
...
blockquote:before {
  background: url("../images/icons/note.png") no-repeat 0 0 transparent;
  content: '';
  height: 26px;
  left: 10px;
  position: absolute;
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  blockquote:before {
    background-image: url("../images/icons/note_@2x.png");
...
.button--secondary:hover, .button--cancel:hover, .button--secondary:active, .button--cancel:active {
  border-color: #00437e;
  border-width: 3px;
  color: #00437e !important;
  padding: 14px 12px;
}
.button--secondary:focus, .button--cancel:focus {
  color: #0065bd;
  background-color: #e5f0f8;
}
...
.button--secondary:active, .button--cancel:active {
...
.button--secondary.button--medium, .button--medium.button--cancel,
.button--cancel.button--medium {
  padding: 8px 13px;
}
.button--secondary.button--medium:hover, .button--medium.button--cancel:hover, .button--secondary.button--medium:active, .button--medium.button--cancel:active,
.button--cancel.button--medium:hover,
.button--cancel.button--medium:active {
  padding: 7px 12px;
}
.button--secondary.button--small, .button--small.button--cancel,
.button--cancel.button--small {
  padding: 8px 13px;
}
.button--secondary.button--small:hover, .button--small.button--cancel:hover, .button--secondary.button--small:active, .button--small.button--cancel:active,
.button--cancel.button--small:hover,
.button--cancel.button--small:active {
  padding: 7px 12px;
}
.button--secondary.button--xsmall, .button--xsmall.button--cancel,
.button--cancel.button--xsmall {
  padding: 2px 13px 1px;
}
.button--secondary.button--xsmall:hover, .button--xsmall.button--cancel:hover, .button--secondary.button--xsmall:active, .button--xsmall.button--cancel:active,
.button--cancel.button--xsmall:hover,
.button--cancel.button--xsmall:active {
...
.button--secondary[href^="//"]:after, [href^="//"].button--cancel:after,
.button--secondary[href^="http://"]:after,
[href^="http://"].button--cancel:after,
.button--secondary[href^="https://"]:after,
[href^="https://"].button--cancel:after {
  background-image: url("../images/icons/svg/external-17-blue.svg");
}
.button--secondary[href^="//"]:hover:after, [href^="//"].button--cancel:hover:after,
.button--secondary[href^="http://"]:hover:after,
[href^="http://"].button--cancel:hover:after,
.button--secondary[href^="https://"]:hover:after,
[href^="https://"].button--cancel:hover:after {
  background-image: url("../images/icons/svg/external-17-dkblue.svg");
}

.button--cancel[href^="//"]:after,
.button--cancel[href^="http://"]:after,
.button--cancel[href^="https://"]:after {
  background-image: url("../images/icons/svg/external-17.svg");
}
...
.close-button {
  background: transparent url("../images/icons/close-grey.png") center no-repeat;
  border: 0;
  display: inline-block;
  height: 27px;
  margin-bottom: 0;
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .close-button {
    background-image: url("../images/icons/close-grey_@2x.png");
...
.button--secondary .mg-icon--left, .button--cancel .mg-icon--left,
.button--cancel .mg-icon--left {
  left: 5px;
}
.button--secondary .mg-icon--right, .button--cancel .mg-icon--right,
.button--cancel .mg-icon--right {
  right: 5px;
}
.button--secondary:hover .mg-icon--left, .button--cancel:hover .mg-icon--left, .button--secondary:active .mg-icon--left, .button--cancel:active .mg-icon--left,
.button--cancel:hover .mg-icon--left,
.button--cancel:active .mg-icon--left {
  left: 4px;
}
.button--secondary:hover .mg-icon--right, .button--cancel:hover .mg-icon--right, .button--secondary:active .mg-icon--right, .button--cancel:active .mg-icon--right,
.button--cancel:hover .mg-icon--right,
.button--cancel:active .mg-icon--right {
  right: 4px;
}

.mg-icon--chevron-left {
  background-image: url("../images/icons/svg/chevron-left-grey.svg");
}

.mg-icon--chevron-right {
  background-image: url("../images/icons/svg/chevron-right-grey.svg");
}

.button--primary .mg-icon--chevron-left {
  background-image: url("../images/icons/svg/chevron-left-white.svg");
}
...
.button--primary .mg-icon--chevron-right {
  background-image: url("../images/icons/svg/chevron-right-white.svg");
}

.button--secondary .mg-icon--chevron-left, .button--cancel .mg-icon--chevron-left {
  background-image: url("../images/icons/svg/chevron-left-dkblue.svg");
}

.button--secondary .mg-icon--chevron-right, .button--cancel .mg-icon--chevron-right {
  background-image: url("../images/icons/svg/chevron-right-dkblue.svg");
}
...
/**
 * Form element style definitions. Include these if your project uses forms.
 */
/*------------------------------------*\
    $MYGOV ASSETS FORM ELEMENTS
\*------------------------------------*/
/*------------------------------------*\
    $FORMS - CHECKBOXES
...
input[type="checkbox"] {
  display: block;
  width: 1px;
  /* having them 0px wide causes Safari to not tab through them */
  height: 1px;
  font-size: 40px;
...
/* ERROR STATE */
.input-error label.fancy-checkbox:before {
  border-color: #d32205;
  border-width: 2px;
}
...
/*------------------------------------*\
    $FORMS - DATE ENTRY
    custom styling for date entry inputs
\*------------------------------------*/
.date-entry {
  margin-bottom: 21px;
  position: relative;
}
.date-entry__input-group {
  position: relative;
}
.date-entry__input {
  margin-right: 60px;
...
.date-entry__calendar--open {
  max-height: 280px;
  max-width: 345px;
}

button.date-entry__trigger {
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  button.date-entry__trigger {
    background-image: url("../images/icons/date_picker_@2x.png");
...
/*------------------------------------*\
    ...
    custom styling for <select> dropdown menus
\*------------------------------------*/
/* Make select arrows hidden in IE 10 */
select::-ms-expand {
  display: none;
}
...
.create-select__arrow:after {
  content: " ";
  background: url("../images/icons/arrows/dd_arrows_35px.png");
  width: 35px;
  height: 42px;
  pointer-events: none;
  position: absolute;
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .create-select__arrow:after {
    background-image: url("../images/icons/arrows/dd_arrows_35px_@2x.png");
...
@media (min-width: 768px) {
  .create-select__arrow:after {
    background: url("../images/icons/arrows/dd_arrows.png");
    width: 42px;
  }
}
@media only screen and (min-width: 768px) and (min--moz-device-pixel-ratio: 1.3), only screen and (min-width: 768px) and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (min-width: 768px) and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-width: 768px) and (min-device-pixel-ratio: 1.3), only screen and (min-width: 768px) and (min-resolution: 1.3dppx) {
  .create-select__arrow:after {
    background-image: url("../images/icons/arrows/dd_arrows_@2x.png");
    background-size: 42px 42px;
  }
}
...
/*------------------------------------*\
    #INPUT GROUP
    for closely-related fields, e.g. radio groups or grouped checkboxes
\*------------------------------------*/
.input-group {
...
.input-group label.fancy-radio {
  margin-top: 6px;
}

/*
    Multi page forms - work in progress
*/
.input--indent {
  margin-left: 56px;
}

.input--inline, .button--inline-block {
  display: inline-block;
}
...
label.fancy-radio:first-of-type {
  margin-top: 14px;
}
...
input + label.fancy-radio:before, label.fancy-radio:before {
  background-color: #ffffff;
...
/* CHECKED STATE */
input:checked + label.fancy-radio:before {
  border-color: #0065bd;
  color: #0065bd;
  background-color: #ffffff;
  content: '\f111';
...
/* ERROR STATE */
.input-error + label.fancy-radio:before {
  border-color: #d32205;
  color: #d32205;
}
...
.card--hover:active, .card--hover:focus {
  background: #d9effc;
  box-shadow: 1px 1px 4px rgba(0, 0, 0, 0.35);
}
.card--hover:active a, .card--hover:focus a {
  color: #00437e;
}
.card--hover:after {
  background: #0065bd;
...
.category-item__header--group-header {
  margin: 0 -15px 34px;
  padding: 7px 15px;
  text-align: center;
...
.category-item__header--group-header--sticky .title-text {
  background: #ffffff;
}
...
.category-item__title .title-text {
  background: #f8f8f8;
  padding: 0 15px;
...
.category-item__title .title-text--sticky {
  background: #ffffff;
}
.category-item__title--group-title {
  color: #00437e;
  display: inline-block;
  font-size: 18px;
  font-weight: 700;
...
.category-item__title--group-title:before {
  background: #00437e;
  content: '';
  height: 1px;
  left: 0;
...
.category-item__title:focus, .category-item__summary:focus {
  outline: none;
}
...
@media (min-width: 768px) {
  .category-item-container.nth-child-2 {
    clear: left;
  }
}
@media (min-width: 992px) {
  ...
  .category-item-container.nth-child-3 {
    clear: left;
  }
}
...
/*------------------------------------*\
    #DOCUMENT INFO
\*------------------------------------*/
.document-info-cell, .document-info {
  overflow: hidden;
}
.document-info-cell:not(:last-child), .document-info:not(:last-child) {
  border-bottom: 1px solid #e3e3e3;
  padding-bottom: 34px;
}
...
.document-info__title a {
  text-decoration: underline;
}
.document-info__title--upper {
  display: block;
}
.document-info__title--lower {
  display: none;
}
.document-info__text {
  margin-left: 90px;
}
.document-info--limelight .document-info__text {
  margin-left: 127px;
}
...
.document-info__thumbnail--main {
  padding-bottom: 49px;
}
.document-info__thumbnail--pdf .document-info__thumbnail-link:after {
  content: "PDF";
}
.document-info__thumbnail--rtf .document-info__thumbnail-link:after {
  content: "RTF";
}
.document-info__thumbnail--xls .document-info__thumbnail-link:after, .document-info__thumbnail--xlsx .document-info__thumbnail-link:after {
  content: "XLS";
}
.document-info__thumbnail--doc .document-info__thumbnail-link:after, .document-info__thumbnail--docx .document-info__thumbnail-link:after {
  content: "DOC";
}
.document-info--limelight .document-info__thumbnail {
  width: 107px;
}
...
.document-info__thumbnail-link:after {
  font-size: 26px;
  font-weight: 300;
  left: 0;
  line-height: 0;
...
.document-info__thumbnail-link:focus .document-info__thumbnail-image, .document-info__thumbnail-link:hover .document-info__thumbnail-image {
  opacity: 0.25;
  transition-duration: 0.2s;
}
.document-info__thumbnail-link:focus:after, .document-info__thumbnail-link:hover:after {
  opacity: 1;
  display: block;
}
...
.document-info__thumbnail-button:focus {
  color: #0065bd;
}
.document-info__thumbnail-button:hover {
  color: #00437e;
}
...
.document-info__page-count, .document-info__file-size {
  margin: 0 0 14px;
  padding: 0 8px;
}
...
.document-info__meta dd {
  display: inline;
}
.document-info__meta dd:not(:first-of-type) {
  border-left: 1px solid #333333;
  margin-left: 8px;
  padding-left: 10px;
}
.document-info__disclaimer {
  color: #727272;
  font-size: 14px;
  line-height: 21px;
}
.document-info__inline-title {
  text-transform: uppercase;
}
...
@media (min-width: 768px) {
  ...
  .document-info--columns .document-info__title--upper {
    display: none;
  }
  .document-info--columns .document-info__title--lower {
    display: block;
  }
  ...
  .document-info--columns .document-info__thumbnail-button {
    display: none;
  }
  .document-info--columns .document-info__text {
    margin-left: 127px;
  }
  .document-info--columns .document-info__page-count,
  .document-info--columns .document-info__file-size {
    display: block;
    padding: 0;
  }
  .document-info--columns .document-info__footer {
    clear: both;
    display: table;
    margin-top: 14px;
  }
  .document-info--columns .document-info__download-wrapper {
    display: block;
    padding-right: 20px;
    width: 185px;
  }
  .document-info--columns .document-info__cell {
    display: table-cell;
    vertical-align: top;
  }
  .document-info__download {
    position: absolute;
    right: 0;
    top: 0;
  }
...
.document-info--old-style:not(.document-info--main) {
  border-bottom: 0 !important;
  padding-bottom: 0 !important;
}
.document-info--old-style .document-info__title {
  font-weight: 500;
}
.document-info--old-style .document-info__thumbnail {
  float: none;
  margin: 0 auto;
  padding-bottom: 56px;
  width: 107px;
}
.document-info--old-style .document-info__text {
  margin-left: 0;
  margin-right: 0;
}
.document-info--old-style .document-info__file-details {
  margin-top: 21px;
}
.document-info--old-style.document-info--main {
  background-color: #f8f8f8;
...
@media (min-width: 768px) {
  .document-info--old-style.document-info--columns {
    text-align: left;
  }
  .document-info--old-style.document-info--columns .document-info__thumbnail {
    float: left;
    padding-bottom: 0;
    width: 165px;
  }
  .document-info--old-style.document-info--columns .document-info__text {
    margin-left: 185px;
  }
}
...
.expandable-item__icon {
  background: url("../images/icons/arrows/int_arrow_down_blue_35px.png") no-repeat center transparent;
  border-radius: 100%;
  height: 35px;
  margin-top: -18px;
  position: absolute;
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .expandable-item__icon {
    background-image: url("../images/icons/arrows/int_arrow_down_blue_35px_@2x.png");
...
.expandable-item__body :first-child {
  margin-top: 0;
}
.expandable-item__link-trigger:after {
  background: url("../images/icons/arrows/down_arrow_18px.png") no-repeat center center #0065bd;
  background-size: contain;
  border-radius: 18px;
  content: '';
  display: inline-block;
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .expandable-item__link-trigger:after {
    background-image: url("../images/icons/arrows/down_arrow_18px_@2x.png");
...
.expandable-item--open .expandable-item__header .expandable-item__icon {
  background: url("../images/icons/arrows/int_arrow_up_blue_35px.png") no-repeat center transparent;
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .expandable-item--open .expandable-item__header .expandable-item__icon {
    background-image: url("../images/icons/arrows/int_arrow_up_blue_35px_@2x.png");
    background-size: 35px 35px;
  }
}
...
.expandable-item--open .expandable-item__link-trigger:after {
  background-image: url("../images/icons/arrows/up_arrow_18px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .expandable-item--open .expandable-item__link-trigger:after {
    background-image: url("../images/icons/arrows/up_arrow_18px_@2x.png");
    background-size: 18px 18px;
  }
}
...
@media (min-width: 768px) {
  ...
  .expandable-item__body:not(.expandable-item__body--with-padding) {
    padding-left: 0;
    padding-right: 0;
  }
}
...
.file-icon {
  ...
  width: 34px;
  height: 48.994px;
  background: url("../images/icons/documents/gen_34px.png") no-repeat center center #ffffff;
}
.file-icon:before {
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon {
    background-image: url("../images/icons/documents/gen_34px_@2x.png");
    background-size: 34px 48px;
  }
}
.file-icon.file-icon--GIF, .file-icon.file-icon--PNG, .file-icon.file-icon--JPG, .file-icon.file-icon--JPEG {
  background-image: url("../images/icons/documents/image_34px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon.file-icon--GIF, .file-icon.file-icon--PNG, .file-icon.file-icon--JPG, .file-icon.file-icon--JPEG {
    background-image: url("../images/icons/documents/image_34px_@2x.png");
    background-size: 34px 48px;
  }
}
.file-icon.file-icon--DOC, .file-icon.file-icon--DOCX {
  background-image: url("../images/icons/documents/word_34px.png");
  border-color: #0065bd;
}
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon.file-icon--DOC, .file-icon.file-icon--DOCX {
    background-image: url("../images/icons/documents/word_34px_@2x.png");
    background-size: 34px 48px;
  }
}
.file-icon.file-icon--PDF {
  background-image: url("../images/icons/documents/pdf_34px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon.file-icon--PDF {
    background-image: url("../images/icons/documents/pdf_34px_@2x.png");
    background-size: 34px 48px;
  }
}
.file-icon.file-icon--XLS, .file-icon.file-icon--XLSX, .file-icon.file-icon--XLSM {
  background-image: url("../images/icons/documents/excel_34px.png");
  border-color: #4e9d52;
}
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon.file-icon--XLS, .file-icon.file-icon--XLSX, .file-icon.file-icon--XLSM {
    background-image: url("../images/icons/documents/excel_34px_@2x.png");
    background-size: 34px 48px;
  }
}
.file-icon.file-icon--PPT, .file-icon.file-icon--PPTX, .file-icon.file-icon--PPS, .file-icon.file-icon--PPSX {
  background-image: url("../images/icons/documents/ppt_34px.png");
  border-color: #e87621;
}
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon.file-icon--PPT, .file-icon.file-icon--PPTX, .file-icon.file-icon--PPS, .file-icon.file-icon--PPSX {
    background-image: url("../images/icons/documents/ppt_34px_@2x.png");
    background-size: 34px 48px;
  }
}
.file-icon.file-icon--RTF {
  background-image: url("../images/icons/documents/rtf_34px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon.file-icon--RTF {
    background-image: url("../images/icons/documents/rtf_34px_@2x.png");
    background-size: 34px 48px;
  }
}
.file-icon.file-icon--TXT {
  background-image: url("../images/icons/documents/txt_34px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon.file-icon--TXT {
    background-image: url("../images/icons/documents/txt_34px_@2x.png");
    background-size: 34px 48px;
  }
}
.file-icon.file-icon--XML, .file-icon.file-icon--XSD {
  background-image: url("../images/icons/documents/xml_34px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon.file-icon--XML, .file-icon.file-icon--XSD {
    background-image: url("../images/icons/documents/xml_34px_@2x.png");
    background-size: 34px 48px;
  }
}
.file-icon.file-icon--CSV {
  background-image: url("../images/icons/documents/csv_34px.png");
  border-color: #4e9d52;
}
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon.file-icon--CSV {
    background-image: url("../images/icons/documents/csv_34px_@2x.png");
    background-size: 34px 48px;
  }
}
.file-icon.file-icon--KML, .file-icon.file-icon--KMZ {
  background-image: url("../images/icons/documents/geo_34px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon.file-icon--KML, .file-icon.file-icon--KMZ {
    background-image: url("../images/icons/documents/geo_34px_@2x.png");
    background-size: 34px 48px;
  }
}
.file-icon--medium {
  ...
  width: 100%;
  background: url("../images/icons/documents/gen_70px.png") no-repeat center center #ffffff;
}
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--medium {
    background-image: url("../images/icons/documents/gen_70px_@2x.png");
...
.file-icon--medium.file-icon--GIF, .file-icon--medium.file-icon--PNG, .file-icon--medium.file-icon--JPG, .file-icon--medium.file-icon--JPEG {
  background-image: url("../images/icons/documents/image_70px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--medium.file-icon--GIF, .file-icon--medium.file-icon--PNG, .file-icon--medium.file-icon--JPG, .file-icon--medium.file-icon--JPEG {
    background-image: url("../images/icons/documents/image_70px_@2x.png");
    background-size: 70px 100px;
  }
}
.file-icon--medium.file-icon--DOC, .file-icon--medium.file-icon--DOCX {
  background-image: url("../images/icons/documents/word_70px.png");
  border-color: #0065bd;
}
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--medium.file-icon--DOC, .file-icon--medium.file-icon--DOCX {
    background-image: url("../images/icons/documents/word_70px_@2x.png");
    background-size: 70px 100px;
  }
}
.file-icon--medium.file-icon--PDF {
  background-image: url("../images/icons/documents/pdf_70px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--medium.file-icon--PDF {
    background-image: url("../images/icons/documents/pdf_70px_@2x.png");
    background-size: 70px 100px;
  }
}
.file-icon--medium.file-icon--XLS, .file-icon--medium.file-icon--XLSX, .file-icon--medium.file-icon--XLSM {
  background-image: url("../images/icons/documents/excel_70px.png");
  border-color: #4e9d52;
}
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--medium.file-icon--XLS, .file-icon--medium.file-icon--XLSX, .file-icon--medium.file-icon--XLSM {
    background-image: url("../images/icons/documents/excel_70px_@2x.png");
    background-size: 70px 100px;
  }
}
.file-icon--medium.file-icon--PPT, .file-icon--medium.file-icon--PPTX, .file-icon--medium.file-icon--PPS, .file-icon--medium.file-icon--PPSX {
  background-image: url("../images/icons/documents/ppt_70px.png");
  border-color: #e87621;
}
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--medium.file-icon--PPT, .file-icon--medium.file-icon--PPTX, .file-icon--medium.file-icon--PPS, .file-icon--medium.file-icon--PPSX {
    background-image: url("../images/icons/documents/ppt_70px_@2x.png");
    background-size: 70px 100px;
  }
}
.file-icon--medium.file-icon--RTF {
  background-image: url("../images/icons/documents/rtf_70px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--medium.file-icon--RTF {
    background-image: url("../images/icons/documents/rtf_70px_@2x.png");
    background-size: 70px 100px;
  }
}
.file-icon--medium.file-icon--TXT {
  background-image: url("../images/icons/documents/txt_70px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--medium.file-icon--TXT {
    background-image: url("../images/icons/documents/txt_70px_@2x.png");
    background-size: 70px 100px;
  }
}
.file-icon--medium.file-icon--XML, .file-icon--medium.file-icon--XSD {
  background-image: url("../images/icons/documents/xml_70px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--medium.file-icon--XML, .file-icon--medium.file-icon--XSD {
    background-image: url("../images/icons/documents/xml_70px_@2x.png");
    background-size: 70px 100px;
  }
}
.file-icon--medium.file-icon--CSV {
  background-image: url("../images/icons/documents/csv_70px.png");
  border-color: #4e9d52;
}
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--medium.file-icon--CSV {
    background-image: url("../images/icons/documents/csv_70px_@2x.png");
    background-size: 70px 100px;
  }
}
.file-icon--medium.file-icon--KML, .file-icon--medium.file-icon--KMZ {
  background-image: url("../images/icons/documents/geo_70px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--medium.file-icon--KML, .file-icon--medium.file-icon--KMZ {
    background-image: url("../images/icons/documents/geo_70px_@2x.png");
    background-size: 70px 100px;
  }
}
.file-icon--large {
  padding-bottom: 144.1%;
  width: 100%;
  background: url("../images/icons/documents/gen_107px.png") no-repeat center center #ffffff;
}
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--large {
    background-image: url("../images/icons/documents/gen_107px_@2x.png");
...
.file-icon--large.file-icon--GIF, .file-icon--large.file-icon--PNG, .file-icon--large.file-icon--JPG, .file-icon--large.file-icon--JPEG {
  background-image: url("../images/icons/documents/image_107px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--large.file-icon--GIF, .file-icon--large.file-icon--PNG, .file-icon--large.file-icon--JPG, .file-icon--large.file-icon--JPEG {
    background-image: url("../images/icons/documents/image_107px_@2x.png");
    background-size: 107px 152px;
  }
}
.file-icon--large.file-icon--DOC, .file-icon--large.file-icon--DOCX {
  background-image: url("../images/icons/documents/word_107px.png");
  border-color: #0065bd;
}
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--large.file-icon--DOC, .file-icon--large.file-icon--DOCX {
    background-image: url("../images/icons/documents/word_107px_@2x.png");
    background-size: 107px 152px;
  }
}
.file-icon--large.file-icon--PDF {
  background-image: url("../images/icons/documents/pdf_107px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--large.file-icon--PDF {
    background-image: url("../images/icons/documents/pdf_107px_@2x.png");
    background-size: 107px 152px;
  }
}
.file-icon--large.file-icon--XLS, .file-icon--large.file-icon--XLSX, .file-icon--large.file-icon--XLSM {
  background-image: url("../images/icons/documents/excel_107px.png");
  border-color: #4e9d52;
}
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--large.file-icon--XLS, .file-icon--large.file-icon--XLSX, .file-icon--large.file-icon--XLSM {
    background-image: url("../images/icons/documents/excel_107px_@2x.png");
    background-size: 107px 152px;
  }
}
.file-icon--large.file-icon--PPT, .file-icon--large.file-icon--PPTX, .file-icon--large.file-icon--PPS, .file-icon--large.file-icon--PPSX {
  background-image: url("../images/icons/documents/ppt_107px.png");
  border-color: #e87621;
}
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--large.file-icon--PPT, .file-icon--large.file-icon--PPTX, .file-icon--large.file-icon--PPS, .file-icon--large.file-icon--PPSX {
    background-image: url("../images/icons/documents/ppt_107px_@2x.png");
    background-size: 107px 152px;
  }
}
.file-icon--large.file-icon--RTF {
  background-image: url("../images/icons/documents/rtf_107px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--large.file-icon--RTF {
    background-image: url("../images/icons/documents/rtf_107px_@2x.png");
    background-size: 107px 152px;
  }
}
.file-icon--large.file-icon--TXT {
  background-image: url("../images/icons/documents/txt_107px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--large.file-icon--TXT {
    background-image: url("../images/icons/documents/txt_107px_@2x.png");
    background-size: 107px 152px;
  }
}
.file-icon--large.file-icon--XML, .file-icon--large.file-icon--XSD {
  background-image: url("../images/icons/documents/xml_107px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--large.file-icon--XML, .file-icon--large.file-icon--XSD {
    background-image: url("../images/icons/documents/xml_107px_@2x.png");
    background-size: 107px 152px;
  }
}
.file-icon--large.file-icon--CSV {
  background-image: url("../images/icons/documents/csv_107px.png");
  border-color: #4e9d52;
}
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--large.file-icon--CSV {
    background-image: url("../images/icons/documents/csv_107px_@2x.png");
    background-size: 107px 152px;
  }
}
.file-icon--large.file-icon--KML, .file-icon--large.file-icon--KMZ {
  background-image: url("../images/icons/documents/geo_107px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--large.file-icon--KML, .file-icon--large.file-icon--KMZ {
    background-image: url("../images/icons/documents/geo_107px_@2x.png");
    background-size: 107px 152px;
  }
}
.file-icon--xlarge {
  padding-bottom: 144.1%;
  width: 100%;
  background: url("../images/icons/documents/gen_165px.png") no-repeat center center #ffffff;
}
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--xlarge {
    background-image: url("../images/icons/documents/gen_165px_@2x.png");
...
.file-icon--xlarge.file-icon--GIF, .file-icon--xlarge.file-icon--PNG, .file-icon--xlarge.file-icon--JPG, .file-icon--xlarge.file-icon--JPEG {
  background-image: url("../images/icons/documents/image_165px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--xlarge.file-icon--GIF, .file-icon--xlarge.file-icon--PNG, .file-icon--xlarge.file-icon--JPG, .file-icon--xlarge.file-icon--JPEG {
    background-image: url("../images/icons/documents/image_165px_@2x.png");
    background-size: 165px 235px;
  }
}
.file-icon--xlarge.file-icon--DOC, .file-icon--xlarge.file-icon--DOCX {
  background-image: url("../images/icons/documents/word_165px.png");
  border-color: #0065bd;
}
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--xlarge.file-icon--DOC, .file-icon--xlarge.file-icon--DOCX {
    background-image: url("../images/icons/documents/word_165px_@2x.png");
    background-size: 165px 235px;
  }
}
.file-icon--xlarge.file-icon--PDF {
  background-image: url("../images/icons/documents/pdf_165px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--xlarge.file-icon--PDF {
    background-image: url("../images/icons/documents/pdf_165px_@2x.png");
    background-size: 165px 235px;
  }
}
.file-icon--xlarge.file-icon--XLS, .file-icon--xlarge.file-icon--XLSX, .file-icon--xlarge.file-icon--XLSM {
  background-image: url("../images/icons/documents/excel_165px.png");
  border-color: #4e9d52;
}
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--xlarge.file-icon--XLS, .file-icon--xlarge.file-icon--XLSX, .file-icon--xlarge.file-icon--XLSM {
    background-image: url("../images/icons/documents/excel_165px_@2x.png");
    background-size: 165px 235px;
  }
}
.file-icon--xlarge.file-icon--PPT, .file-icon--xlarge.file-icon--PPTX, .file-icon--xlarge.file-icon--PPS, .file-icon--xlarge.file-icon--PPSX {
  background-image: url("../images/icons/documents/ppt_165px.png");
  border-color: #e87621;
}
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--xlarge.file-icon--PPT, .file-icon--xlarge.file-icon--PPTX, .file-icon--xlarge.file-icon--PPS, .file-icon--xlarge.file-icon--PPSX {
    background-image: url("../images/icons/documents/ppt_165px_@2x.png");
    background-size: 165px 235px;
  }
}
.file-icon--xlarge.file-icon--RTF {
  background-image: url("../images/icons/documents/rtf_165px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--xlarge.file-icon--RTF {
    background-image: url("../images/icons/documents/rtf_165px_@2x.png");
    background-size: 165px 235px;
  }
}
.file-icon--xlarge.file-icon--TXT {
  background-image: url("../images/icons/documents/txt_165px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--xlarge.file-icon--TXT {
    background-image: url("../images/icons/documents/txt_165px_@2x.png");
    background-size: 165px 235px;
  }
}
.file-icon--xlarge.file-icon--XML, .file-icon--xlarge.file-icon--XSD {
  background-image: url("../images/icons/documents/xml_165px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--xlarge.file-icon--XML, .file-icon--xlarge.file-icon--XSD {
    background-image: url("../images/icons/documents/xml_165px_@2x.png");
    background-size: 165px 235px;
  }
}
.file-icon--xlarge.file-icon--CSV {
  background-image: url("../images/icons/documents/csv_165px.png");
  border-color: #4e9d52;
}
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--xlarge.file-icon--CSV {
    background-image: url("../images/icons/documents/csv_165px_@2x.png");
    background-size: 165px 235px;
  }
}
.file-icon--xlarge.file-icon--KML, .file-icon--xlarge.file-icon--KMZ {
  background-image: url("../images/icons/documents/geo_165px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .file-icon--xlarge.file-icon--KML, .file-icon--xlarge.file-icon--KMZ {
    background-image: url("../images/icons/documents/geo_165px_@2x.png");
    background-size: 165px 235px;
  }
}
...
.info-note.caution:before {
  background: url("../images/icons/caution.png") no-repeat 0 0 transparent;
  content: '';
  height: 36px;
  left: 10px;
  position: absolute;
...
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .info-note.caution:before {
    background-image: url("../images/icons/caution_@2x.png");
...
.page-group__toggle:after {
  ...
  top: -1px;
  width: 63px;
  background: url("../images/icons/arrows/dd_handle.png") no-repeat #0065bd center;
  transition: background-color 0.2s, border-color 0.2s;
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .page-group__toggle:after {
    background-image: url("../images/icons/arrows/dd_handle_@2x.png");
...
.page-group-content-list__link:hover {
  background: #f8f8f8;
  transition: background-color 0.2s;
}
.page-group-content-list__link:hover .page-group-content-list__title {
  text-decoration: underline;
}
.page-group-content-list__link:active {
  background: #d9effc;
  transition: none;
}
.page-group-content-list__link p {
  color: #333333;
}
...
.page-group__item:first-child .page-group__text {
...
.page-group__item--level-0:first-of-type > .page-group__text {
  border-top: 0;
}
...
.page-group__item a:before,
.page-group__item span:before {
  background-color: #0065bd;
  border-radius: 21px;
  color: #ffffff;
  font-size: 14px;
...
ul.page-group__list .page-group__item a:before,
ul.page-group__list .page-group__item span:before {
  content: '';
  background: url("../images/icons/arrows/guide_lh_nav_arrow.png") no-repeat 0 center #0065bd;
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  ul.page-group__list .page-group__item a:before,
  ul.page-group__list .page-group__item span:before {
    background-image: url("../images/icons/arrows/guide_lh_nav_arrow_@2x.png");
    background-size: 21px 21px;
  }
}
...
ol.page-group__list .page-group__item {
  counter-increment: li;
}
ol.page-group__list .page-group__item a:before,
ol.page-group__list .page-group__item span:before {
  content: counter(li);
}
...
.page-group__text:active {
  outline: none;
}
.page-group__text--no-link {
  background-color: #e5f0f8;
  border-color: #e5f0f8;
  margin-left: -15px;
  margin-right: -15px;
...
.page-group__text--level-2 {
  padding: 7px 10px;
}
.page-group__text--inactive {
  color: #727272;
}
.page-group__text--link {
  transition: background-color 1s;
}
.page-group__text--link:hover {
  background-color: #f8f8f8;
  text-decoration: none;
  margin-left: -15px;
  margin-right: -15px;
...
@media (min-width: 768px) {
  ...
  .page-group--right:before, .page-group--right:after {
    left: -1px;
    right: auto;
  }
  ...
  .page-group__text--no-link, .page-group__text, .page-group__text:hover {
    margin-left: 0;
    margin-right: 0;
    padding-left: 35px;
  }
  .page-group__text--no-link:after {
  ...
  .page-group--right .page-group__text--no-link:after {
    border-left: 0;
    border-right: 15px solid #e5f0f8;
    left: -15px;
    right: auto;
  }
...
.page-nav__button--left:after {
  background-image: url("../images/icons/arrows/int_arrow_left_56px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .page-nav__button--left:after {
    background-image: url("../images/icons/arrows/int_arrow_left_56px_@2x.png");
    background-size: 56px 56px;
  }
}
.page-nav__button--right {
...
.page-nav__button--right:after {
  background-image: url("../images/icons/arrows/int_arrow_right_56px.png");
}
@media only screen and (min--moz-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6 / 2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx) {
  .page-nav__button--right:after {
    background-image: url("../images/icons/arrows/int_arrow_right_56px_@2x.png");
    background-size: 56px 56px;
  }
}
...
.page-nav__button:hover .page-nav__text {
  text-decoration: underline;
}
.page-nav__button:hover:before {
  background-color: #00437e;
}
...
.page-nav__button:active:before {
  background-color: #00437e;
}
.page-nav__button:active:after {
  opacity: 0.65;
}
...
/**
 * TRUMPS
 * Trumps provide overrides for styles defined in component files where a more
 * specific implementation of a component is desired. They typically extend or
 * augment an existing component.
 */
/*------------------------------------*\
