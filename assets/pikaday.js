 ...
 *
 * Modified Dec 17 2015 by Jonathan Sutcliffe to make Pikaday use moment as a hard dependency
 */
    ...
    var hasMoment = typeof moment === 'function',
        ...
        renderTitle = function(instance, c, year, month, refYear)
        {
            ...
            monthHtml = '<div class="pika-label">' + opts.i18n.months[month] + '<select class="pika-select pika-select-month" tabindex="-1" title="Month">' + arr.join('') + '</select></div>';
            ...
            yearHtml = '<div class="pika-label">' + year + opts.yearSuffix + '<select class="pika-select pika-select-year" tabindex="-1" title="Year">' + arr.join('') + '</select></div>';
